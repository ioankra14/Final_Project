...
<h3 class="card-title">Info Tentang <?=$mahasiswa->nama; ?></h3>
</div>
<!-- /.card-header -->
<div class="card-body">
<strong><i class="fas fa-university mr-1"></i>
Jurusan</strong>
<p class="text-muted"><?= $mahasiswa->jurusan; ?> Pada Sekolah Tinggi Manajemen dan Informatika (STMIK) Palangkaraya</p>
<hr>
<strong><i class="fas fa-mobile-alt mr-1"></i> No Handphone/Whatsapp</strong>
